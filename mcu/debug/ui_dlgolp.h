/********************************************************************************
** Form generated from reading UI file 'dlgolp.ui'
**
...
public:
    ...
    void setupUi(QDialog *dlgOlp)
    {
        if (dlgOlp->objectName().isEmpty())
            dlgOlp->setObjectName(QString::fromUtf8("dlgOlp"));
        dlgOlp->resize(831, 816);
        QFont font;
        font.setFamily(QString::fromUtf8("AR PL UKai CN"));
        font.setPointSize(20);
        dlgOlp->setFont(font);
        gridLayoutWidget = new QWidget(dlgOlp);
        gridLayoutWidget->setObjectName(QString::fromUtf8("gridLayoutWidget"));
        gridLayoutWidget->setGeometry(QRect(89, 120, 211, 91));
        ...
        tabWdgtCard = new QTabWidget(dlgOlp);
        tabWdgtCard->setObjectName(QString::fromUtf8("tabWdgtCard"));
        tabWdgtCard->setGeometry(QRect(100, 90, 651, 681));
        ...
        retranslateUi(dlgOlp);

        tabWdgtCard->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(dlgOlp);
    } // setupUi

    void retranslateUi(QDialog *dlgOlp)
    {
        dlgOlp->setWindowTitle(QApplication::translate("dlgOlp", "Dialog", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("dlgOlp", "\346\234\272\346\241\206", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("dlgOlp", "\346\247\275\344\275\215", 0, QApplication::UnicodeUTF8));
        label_3->setText(QApplication::translate("dlgOlp", "\350\256\276\345\244\207\347\261\273\345\236\213", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("dlgOlp", "\350\275\257\344\273\266\347\211\210\346\234\254", 0, QApplication::UnicodeUTF8));
        pushBtnGetCardVerson->setText(QApplication::translate("dlgOlp", "\350\216\267\345\217\226\346\235\277\345\215\241\347\211\210\346\234\254", 0, QApplication::UnicodeUTF8));
        pushBtnExit->setText(QApplication::translate("dlgOlp", "\351\200\200\345\207\272", 0, QApplication::UnicodeUTF8));
        tabWdgtCard->setTabText(tabWdgtCard->indexOf(tabCardVerson), QApplication::translate("dlgOlp", "\347\211\210\346\234\254\345\217\267", 0, QApplication::UnicodeUTF8));
        tabWdgtCard->setTabText(tabWdgtCard->indexOf(tab_2), QApplication::translate("dlgOlp", "Tab 2", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class dlgOlp: public Ui_dlgOlp {};
} // namespace Ui
