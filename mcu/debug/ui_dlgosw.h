/********************************************************************************
** Form generated from reading UI file 'dlgosw.ui'
**
...
public:
    ...
    void setupUi(QDialog *dlgOsw)
    {
        if (dlgOsw->objectName().isEmpty())
            dlgOsw->setObjectName(QString::fromUtf8("dlgOsw"));
        dlgOsw->resize(985, 871);
        QFont font;
        font.setFamily(QString::fromUtf8("AR PL UKai CN"));
        font.setPointSize(20);
        dlgOsw->setFont(font);
        gridLayoutWidget = new QWidget(dlgOsw);
        gridLayoutWidget->setObjectName(QString::fromUtf8("gridLayoutWidget"));
        gridLayoutWidget->setGeometry(QRect(149, 130, 211, 91));
        ...
        tabWdgtCard = new QTabWidget(dlgOsw);
        tabWdgtCard->setObjectName(QString::fromUtf8("tabWdgtCard"));
        tabWdgtCard->setGeometry(QRect(160, 100, 651, 681));
        ...
        retranslateUi(dlgOsw);

        tabWdgtCard->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(dlgOsw);
    } // setupUi

    void retranslateUi(QDialog *dlgOsw)
    {
        dlgOsw->setWindowTitle(QApplication::translate("dlgOsw", "Dialog", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("dlgOsw", "\346\234\272\346\241\206", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("dlgOsw", "\346\247\275\344\275\215", 0, QApplication::UnicodeUTF8));
        label_3->setText(QApplication::translate("dlgOsw", "\350\256\276\345\244\207\347\261\273\345\236\213", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("dlgOsw", "\350\275\257\344\273\266\347\211\210\346\234\254", 0, QApplication::UnicodeUTF8));
        pushBtnGetCardVerson->setText(QApplication::translate("dlgOsw", "\350\216\267\345\217\226\346\235\277\345\215\241\347\211\210\346\234\254", 0, QApplication::UnicodeUTF8));
        pushBtnExit->setText(QApplication::translate("dlgOsw", "\351\200\200\345\207\272", 0, QApplication::UnicodeUTF8));
        tabWdgtCard->setTabText(tabWdgtCard->indexOf(tabCardVerson), QApplication::translate("dlgOsw", "\347\211\210\346\234\254\345\217\267", 0, QApplication::UnicodeUTF8));
        tabWdgtCard->setTabText(tabWdgtCard->indexOf(tab_2), QApplication::translate("dlgOsw", "Tab 2", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class dlgOsw: public Ui_dlgOsw {};
} // namespace Ui
